    ...
    <section id="top" className="hero">
      ...
      <div className="hero__content">
        ...
        <p className="hero__tagline">
          Fourth-year at Berkeley, building things at the edge of statistics, code, and curiosity.
        </p>
        <p className="hero__bio">
          ...
          darkroom, and a piano. This page is where all of it lives: a running record of what I've
